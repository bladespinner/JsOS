var gamewindow = CreateWindow({
	...
	posx:400,
	posy:300,
	iconUrl:path+"/TicTacToe.gif",
	resizable:false,
	title:"Tic Tac Toe"});

CreateProcess(gamewindow,"tictactoe");
var canvas = document.createElement("canvas");
$(canvas).width(500);
$(canvas).height(500);
$(canvas).attr("onclick","javascript: clickHandler(event);");
$(gamewindow.content).append(canvas);
$(gamewindow.content).css("overflow-y","hidden");
